...
public class CustomerRegistry {
	 ...
	 *
	 * @throws DatabaseFailureException If the database fails to retrieve discount.
	 */
	public List<DiscountDTO> fetchDiscount(String customerID) {
		String databaseFailureTesting = "-1";
		if(customerID.equals(databaseFailureTesting)){
			throw new DatabaseFailureException("Customer database failed when retrieving customer: " + customerID);
		}
